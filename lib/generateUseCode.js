export function generateUseCode(prefix, fullName) {
...
// Example usage:
const prefix = "LFF";
const fullName = "VY HOANG";
const code = generateUseCode(prefix, fullName);
console.log(code); // Example output: LFF-VH-140501123
