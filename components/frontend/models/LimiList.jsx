...
import LimiCarousel from './Carousels/LimiCarousel'

export default function LimiList() {
    return (
        <div className='sm:col-span-3 sm:block bg-white border border-gray-200 rounded-lg  dark:bg-gray-800 dark:border-gray-700 text-neutral-700 overflow-hidden shadow-md hidden mt-6'>
            <div className='flex justify-between items-center rounded-md '>
                <h2 className='bg-neutral-200 py-4 px-6 font-bold border-b text-center uppercase mb-2'>Limi Community List</h2>
